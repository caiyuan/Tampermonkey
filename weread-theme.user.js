...
(function() {
    ...
    if(segments[4] == 'reader') {
        ...
        const commonStyles = `
            ...
            #routerView .app_content .readerChapterContent [class] {font-family: 'HYQiHei_55S','HYShuFang-55W';}
            #routerView .app_content .readerChapterContent [class*='content'] {font-family: 'HYQiHei_55S','HYShuFang-55W';}
